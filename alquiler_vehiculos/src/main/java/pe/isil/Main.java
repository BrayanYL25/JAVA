...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n1ra Reverva: ");
        // Crea un auto
        Vehicle car = new Car("A2Y-12D", "Accent", "Nissan", 4, 100, 5);
        // Crea la reserva
        Booking firstBooking = new Booking(car);
        ...
        System.out.println("\n2da Reserva: ");
        // Crea una van
        Vehicle van = new Van("1JL1-2NS", "Hiace", "Toyota", 500, 150, 6);
        // Crea la reserva
        Booking secondBooking = new Booking(van);
        // Imprime los datos de la reserva
        ...
        System.out.println("\n3ra Reverva: ");
        // Crea un auto
        Vehicle lambo = new Car("AUY-J1K", "Murcielago", "Lamborghini", 2, 1000, 5);
        // Crea la reserva
        Booking thirdBooking = new Booking(lambo);
        // Imprime los datos de la reserva
